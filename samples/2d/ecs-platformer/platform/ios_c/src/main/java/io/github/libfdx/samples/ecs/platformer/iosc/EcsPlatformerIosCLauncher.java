...
/**
 * Launches the ECS platformer iOS C entry point.
 *
 * @author xpenatan
 */
public final class EcsPlatformerIosCLauncher {
    private EcsPlatformerIosCLauncher() {
    }
    ...
    public static void main(String[] args) {
        IosCApplicationConfig config = new IosCApplicationConfig()
                .title("libfdx ECS Platformer - GLES iOS C")
                .size(960, 540)

package io.github.libfdx.samples.g2d.platformer.desktop;
...
/**
 * Launches the platformer desktop entry point.
 *
 * @author xpenatan
 */
public final class PlatformerDesktopLauncher {
    ...
    private PlatformerDesktopLauncher() {
    }
    ...
    private static Properties loadLaunchProperties() {
        ...
        try (InputStream stream = PlatformerDesktopLauncher.class.getClassLoader()

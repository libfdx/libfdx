...
android {
    namespace = "io.github.libfdx.samples.g2d.platformer.android"
    compileSdk = androidCompileSdkVersion

    defaultConfig {
        applicationId = "io.github.libfdx.samples.g2d.platformer.android"
...
base {
    archivesName.set("sample_platformer_android")
}
...
libfdx {
    android {
        applicationId.set("io.github.libfdx.samples.g2d.platformer.android")
        adbExecutable.set(androidComponents.sdkComponents.adb)

        target("gles") {
            displayName.set("Platformer GLES sample")
            activity.set("io.github.libfdx.samples.g2d.platformer.android.PlatformerAndroidGlesActivity")
            runDescription.set("Installs and launches the Android GLES platformer sample.")
        }
        target("wgpu_jni") {
            displayName.set("Platformer WGPU JNI sample")
            activity.set("io.github.libfdx.samples.g2d.platformer.android.PlatformerAndroidWgpuActivity")
            runDescription.set("Installs and launches the Android WGPU JNI platformer sample.")
        }
        target("vulkan") {
            displayName.set("Platformer Vulkan sample")
            activity.set("io.github.libfdx.samples.g2d.platformer.android.PlatformerAndroidVulkanActivity")
            runDescription.set("Installs and launches the Android Vulkan platformer sample.")
        }
        target("vulkan_fallback") {
            displayName.set("Platformer Vulkan fallback sample")
            activity.set(
                "io.github.libfdx.samples.g2d.platformer.android.PlatformerAndroidVulkanFallbackActivity"
            )
            runDescription.set("Installs and launches the Android Vulkan fallback platformer sample.")
        }
    }
}

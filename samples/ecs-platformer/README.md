...
```powershell
.\gradlew.bat "-Dlibfdx.sample.exitAfterFrames=30" "-Dlibfdx.sample.capture=build/reports/ecs-platformer/gl.ppm" :samples:ecs-platformer:platform:desktop:libfdx_desktop_jvm_gl_run
```

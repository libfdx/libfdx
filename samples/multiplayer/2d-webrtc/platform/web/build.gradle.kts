...
tasks.register("multiplayer_2d_webrtc_webgl_js_build") {
    ...
    dependsOn(":samples:multiplayer:2d-webrtc:platform:plugin:libfdx_web_js_webgl_build")
}
...
tasks.register("multiplayer_2d_webrtc_webgl_js_run") {
    ...
    dependsOn(":samples:multiplayer:2d-webrtc:platform:plugin:libfdx_web_js_webgl_run")
}
...
tasks.register("multiplayer_2d_webrtc_webgpu_js_build") {
    ...
    dependsOn(":samples:multiplayer:2d-webrtc:platform:plugin:libfdx_web_js_webgpu_build")
}
...
tasks.register("multiplayer_2d_webrtc_webgpu_js_run") {
    ...
    dependsOn(":samples:multiplayer:2d-webrtc:platform:plugin:libfdx_web_js_webgpu_run")
}

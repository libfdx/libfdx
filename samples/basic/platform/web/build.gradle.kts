...
registerWebBuild("basic_webgl_js_build",
        "Builds the WebGL JavaScript basic sample web application.",
        "js",
        "io.github.libfdx.samples.basic.web.BasicWebJsLauncher",
        "libfdx Basic - WebGL JS",
        jsWebappDir,
        "BALANCED")

registerWebBuild("basic_webgl_wasm_build",
        "Builds the WebGL Wasm basic sample web application.",
        "wasm",
        "io.github.libfdx.samples.basic.web.BasicWebWasmLauncher",
        "libfdx Basic - WebGL Wasm",
        wasmWebappDir,
        "AGGRESSIVE")
...
registerWebRun("basic_webgl_js_run",
        "Builds and serves the WebGL JavaScript basic sample web application.",
        "basic_webgl_js_build", jsWebappDir, "/")

registerWebRun("basic_webgl_wasm_run",
        "Builds and serves the WebGL Wasm basic sample web application.",
        "basic_webgl_wasm_build", wasmWebappDir, "/")

registerWebRun("basic_webgpu_js_run",
        "Builds and serves the WebGPU JavaScript basic sample web application.",
        "basic_webgpu_js_build", jsWebappDir, "/webgpu.html")

registerWebRun("basic_webgpu_wasm_run",
        "Builds and serves the WebGPU Wasm basic sample web application.",
        "basic_webgpu_wasm_build", wasmWebappDir, "/webgpu.html")

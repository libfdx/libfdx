...
- `ui-kit` may depend on `foundation/core`, display/application runtime APIs, `graphics/api`, `graphics:g2d`, and asset modules needed for fonts, skins, and ninepatches.

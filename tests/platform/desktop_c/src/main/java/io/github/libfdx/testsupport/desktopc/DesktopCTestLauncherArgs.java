...
public final class DesktopCTestLauncherArgs {
    ...
    public static DesktopCTestLauncherArgs apply(String[] args) {
    ...
    public String testName() {
        ...
        return positional.length > 0 ? positional[0] : TestSelector.defaultTestName();
    }

 ...
 * @author xpenatan
 */
public final class StorageTest extends ApplicationAdapter {
    private final long exitAfterFrames;
    private Application app;
    private long renderedFrames;

    /**
     * Creates a storage test.
     *
     * @param exitAfterFrames the exit frame count
     */
    public StorageTest(long exitAfterFrames) {
    ...
    public void create(Fdx fdx) {
        ...
        fdx.logger().info("StorageTest stored run " + run + " in " + storage.providerId());
    }

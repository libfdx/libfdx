...
public final class TestCameraControllers {
    ...
    public static boolean autoOrbitEnabled() {
    ...
    public static float autoOrbitStartDegrees() {
        return floatProperty(CAMERA_ORBIT_START_PROPERTY, 0.0f);
    }

    public static float autoOrbitDegrees() {

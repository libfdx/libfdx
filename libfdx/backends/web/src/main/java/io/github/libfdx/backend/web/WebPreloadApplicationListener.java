 ...
 *
 * <p>The backend prepares the native runtime and bootstrap logo before creating this listener, then submits
 * the first rendered preload frame before starting the remaining startup asset downloads.

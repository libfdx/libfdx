...
void libfdx_psp_write_float(void* target, int offset, float value) {
    if (target != NULL && offset >= 0) {
        *((float*)(((unsigned char*) target) + offset)) = value;
    }
}

void libfdx_psp_write_int(void* target, int offset, int value) {
    if (target != NULL && offset >= 0) {
        *((int*)(((unsigned char*) target) + offset)) = value;
    }
}

...
final class WavDecoderTest {
    @Test void decodesSignedStereoAndPreservesIndependentChannels() {
    ...
    @Test void decodesUnsignedEightBitAndSkipsOddPaddedChunks() {
    ...
    @Test void rejectsMalformedOrUnsupportedDataBeforeDecodedAllocation() {
    ...
    @Test void pcmCopiesCallerStorageAndRejectsPartialFrames() {

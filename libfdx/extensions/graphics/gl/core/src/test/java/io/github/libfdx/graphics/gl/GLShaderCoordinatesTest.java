...
final class GLShaderCoordinatesTest {
    @Test
    void translatedPositionUsesCameraCoordinatesRegardlessOfBuiltinFieldName() {
    ...
    @Test
    void conversionAcceptsTranslatorWhitespaceAndFloatLiteralVariants() {
    ...
    @Test
    void ordinaryGlslAndUnrelatedExpressionsArePreserved() {

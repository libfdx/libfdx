...
/**
 * WebRTC peer-group configuration.
 *
 * @author xpenatan
 */
public final class WebRtcPeerConfig extends NetPeerConfig {
    ...
    private WebRtcPeerConfig(Builder builder) {
        super(builder);
        signalingUrl = builder.signalingUrl;
        roomId = builder.roomId;
        peerId = builder.peerId;
        maxPeers = validateNonNegative("max peers", builder.maxPeers);
    ...
    /**
     * Builder for WebRTC peer-group configuration.
     *
     * @author xpenatan
     */
    public static final class Builder extends NetPeerConfig.Builder<Builder> {
        ...
        public WebRtcPeerConfig build() {
            return new WebRtcPeerConfig(this);
        }

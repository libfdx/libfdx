...
/**
 * Android Java-WebSocket signaling client.
 *
 * @author xpenatan
 */
public final class AndroidWebRtcSignalingClient implements WebRtcSignalingClient {
        ...
        socket = new org.java_websocket.client.WebSocketClient(uri) {
            ...
            public void onMessage(String message) {
                ...
                if (decoded.type() == WebRtcSignalingMessageType.WELCOME) {
                    ...
                    AndroidWebRtcSignalingClient.this.listener.connected(localPeerId);
                }
                AndroidWebRtcSignalingClient.this.listener.message(decoded);
            }

            @Override
            public void onClose(int code, String reason, boolean remote) {
                AndroidWebRtcSignalingClient.this.listener.disconnected(reason);
            }

            @Override
            public void onError(Exception ex) {
                AndroidWebRtcSignalingClient.this.listener.error(ex);
            }
        };
        socket.connect();
    }

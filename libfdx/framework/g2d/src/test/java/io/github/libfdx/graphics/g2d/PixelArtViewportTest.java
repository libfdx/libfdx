...
final class PixelArtViewportTest {
    @Test
    void integerFitCentersMarginsAndMapsInputBackToWorld() {
    ...
    @Test
    void smallFramebufferCropsAtOneTimesAndOddMarginsHaveStablePlacement() {
    ...
    @Test
    void snappingIsStableForNegativeCoordinatesAndDoesNotChangeSimulationValues() {
    ...
    @Test
    void validatesDimensionsAndAvoidsOverflowForExtremeSizes() {

...
public final class TileMap extends io.github.libfdx.maps.TileMap {
    ...
    @Override
    public TileMap addLayer(io.github.libfdx.maps.TileLayer layer) {
    ...
    @Override
    public TileLayer layer(int index) { return (TileLayer)super.layer(index); }
    @Override
    public TileLayer removeLayer(int index) { return (TileLayer)super.removeLayer(index); }
}

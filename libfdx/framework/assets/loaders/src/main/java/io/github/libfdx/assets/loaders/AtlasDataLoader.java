...
public final class AtlasDataLoader implements AssetLoader<AtlasData> {
    ...
    @Override public Class<AtlasData> type() { return AtlasData.class; }
    @Override public FdxFuture<AtlasData> load(AssetLoadContext context,AssetDescriptor<AtlasData> descriptor) {

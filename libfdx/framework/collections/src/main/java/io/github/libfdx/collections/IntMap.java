...
public final class IntMap<V> {
     ...
     * @return this map
     */
    public IntMap<V> ensureCapacity(int additionalCapacity) {
    ...
    /**
     * Represents an int-key map entry.
     *
     * @param <V> the value type
     * @author xpenatan
     */
    ...
    /**
     * Iterable view over int keys.
     *
     * @author xpenatan
     */
    public static final class Keys implements Iterable<Integer> {
        private final IntMap<?> map;

        private Keys(IntMap<?> map) {
            this.map = map;
        }
    ...
    /**
     * Iterator over int keys.
     *
     * @author xpenatan
     */
    public static final class KeyIterator implements Iterator<Integer> {
        private final IntMap<?> map;
        private int nextIndex;
        private int returned;

        private KeyIterator(IntMap<?> map) {
            this.map = map;
            findNext();
        }

...
/**
 * Maps primitive int keys to values with stable ordered traversal and packed
 ...
 * {@link #moveToFirst(int)} and {@link #moveToLast(int)}. Replacing a value
 ...
 * @author xpenatan
 */
public final class OrderedIntMap<V> implements IntMapView<V> {
    ...
    /** Creates an ordered primitive-int map. */
     ...
     */
    public OrderedIntMap(int capacity) {
     ...
     */
    public OrderedIntMap(IntMapView<? extends V> values) {
     ...
     */
    public OrderedIntMap(int capacity, float loadFactor) {
        if (capacity < 0) {
     ...
     * @return this map
     */
    public OrderedIntMap<V> putAll(IntMapView<? extends V> source) {
        if (source == null) {
     ...
     * @return this map
     */
    public OrderedIntMap<V> moveToFirst(int key) {
     ...
     * @return this map
     */
    public OrderedIntMap<V> moveToLast(int key) {
        int denseIndex = requireDenseIndex(key);
        if (denseIndex == last) {
            return this;
        }
     ...
     * @return this map
     */
    public OrderedIntMap<V> ensureCapacity(int additionalCapacity) {
    ...
    public int firstKey() {
        if (first < 0) {
            throw new NoSuchElementException("OrderedIntMap is empty");
        }
    ...
    private int requireDenseIndex(int key) {
        int tableSlot = locate(key);
        if (tableSlot < 0) {
    ...
    private static final class Entries<V> implements ObjectIterable<Entry<V>> {
        private final OrderedIntMap<V> map;
        private EntryIterator<V> iterator;

        Entries(OrderedIntMap<V> map) {
            this.map = map;
        }
    ...
    private static final class EntryIterator<V> implements ObjectIterator<Entry<V>> {
        ...
        EntryIterator(OrderedIntMap<V> map) {
            this.map = map;
        }
    ...
    private static final class Keys implements IntIterable {
        private final OrderedIntMap<?> map;
        private KeyIterator iterator;

        Keys(OrderedIntMap<?> map) {
            this.map = map;
        }
    ...
    private static final class ValueIterator<V> implements ObjectIterator<V> {
        ...
        ValueIterator(OrderedIntMap<V> map) {
            this.map = map;
        }
    ...
    private static final class ReadOnlyView<V> implements IntMapView<V> {
        private final OrderedIntMap<V> map;

        ReadOnlyView(OrderedIntMap<V> map) {
            this.map = map;
        }

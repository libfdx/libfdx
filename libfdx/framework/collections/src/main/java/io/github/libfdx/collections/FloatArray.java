...
public final class FloatArray {
     ...
     * @return this array
     */
    public FloatArray addAll(FloatArray values) {
     ...
     * @return this array
     */
    public FloatArray insert(int index, float value) {
    ...
    public int indexOf(float value) {
        ...
        for (int i = 0; i < size; i++) {
            if (Float.floatToIntBits(items[i]) == bits) {
                return i;
            }
        }
        return -1;
     ...
     */
    public boolean removeAll(FloatArray values) {
        if (values == this) {
     ...
     * @return this array
     */
    public FloatArray removeRange(int start, int end) {
     ...
     * @return this array
     */
    public FloatArray swap(int first, int second) {
        checkIndex(first);
        checkIndex(second);
        float value = items[first];
     ...
     * @return this array
     */
    public FloatArray truncate(int newSize) {
        if (newSize < 0) {
     ...
     * @return this array
     */
    public FloatArray ensureCapacity(int additionalCapacity) {
     ...
     * @return this array
     */
    public FloatArray ordered(boolean ordered) {
        this.ordered = ordered;
        return this;
    }

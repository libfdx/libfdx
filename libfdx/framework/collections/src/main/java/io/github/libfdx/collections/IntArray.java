...
/**
 * Stores primitive int values in a reusable growable array.
 *
 * <p><b>Algorithm:</b> Values occupy a packed prefix of a contiguous
 * {@code int[]} that grows when its capacity is exhausted.</p>
 *
 ...
 * @author xpenatan
 */
public final class IntArray implements IntIterable {
    private int[] items;
    private int size;
     ...
     * @return this array
     */
    public IntArray addAll(IntArray values) {
     ...
     * @return this array
     */
    public IntArray insert(int index, int value) {
     ...
     */
    public boolean removeAll(IntArray values) {
        if (values == this) {
     ...
     * @return this array
     */
    public IntArray removeRange(int start, int end) {
     ...
     * @return this array
     */
    public IntArray swap(int first, int second) {
        checkIndex(first);
        checkIndex(second);
     ...
     * @return this array
     */
    public IntArray truncate(int newSize) {
        if (newSize < 0) {
     ...
     * @return this array
     */
    public IntArray ensureCapacity(int additionalCapacity) {
     ...
     * @return this array
     */
    public IntArray ordered(boolean ordered) {
        this.ordered = ordered;
        return this;
    }

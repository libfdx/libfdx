...
include(":libfdx:framework:audio")
include(":libfdx:extensions:audio:loaders")
include(":libfdx:extensions:audio:openal")
include(":libfdx:extensions:audio:web")
...
include(":libfdx:framework:maps")
include(":libfdx:extensions:maps:tiled")
include(":libfdx:extensions:maps:streaming")
...
include(":libfdx:tools:texturepacker")
include(":libfdx:tools:ibl")
...
include(":libfdx:extensions:graphics:effects")

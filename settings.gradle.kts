...
include(":libfdx:foundation:collections")
include(":libfdx:runtime:application")
include(":libfdx:runtime:fdx:core")
include(":libfdx:runtime:fdx:fdx-build")
...
include(":libfdx:runtime:net")
include(":libfdx:runtime:storage")
include(":libfdx:assets:manager")
include(":libfdx:assets:loaders")
include(":libfdx:graphics:api")
include(":libfdx:graphics:camera")

...
include(":libfdx:tools:shader:core")
include(":libfdx:tools:shader:platform:android_jni")
include(":libfdx:tools:shader:platform:web")
include(":libfdx:tools:shader:platform:desktop_ffm")
